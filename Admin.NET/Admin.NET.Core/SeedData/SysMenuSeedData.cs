...
public class SysMenuSeedData : ISqlSugarEntitySeedData<SysMenu>
{
    ...
    public IEnumerable<SysMenu> HasData()
    {
        return new[]
        {
            ...
            new SysMenu{ Id=1300000000122, Pid=0, Title="流程管理", Path="/oa", Name="oa", Component="Layout", Redirect="/oa/oaflowcate", Icon="fa fa-braille", Type=MenuTypeEnum.Dir, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000123, Pid=1300000000122, Title="流程分类", Path="/oa/oaflowcate", Name="OaFlowCateManagement", Component="/system/oa/oaFlowCate/index",  Icon="fa fa-handshake-o", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000124, Pid=1300000000123, Title="查询", Permission="oaFlowCate:page", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000125, Pid=1300000000123, Title="编辑", Permission="oaFlowCate:edit", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000126, Pid=1300000000123, Title="增加", Permission="oaFlowCate:add", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000127, Pid=1300000000123, Title="删除", Permission="oaFlowCate:delete", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000128, Pid=1300000000123, Title="详情", Permission="oaFlowCate:detail", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },

            new SysMenu{ Id=1300000000129, Pid=1300000000122, Title="流程模板", Path="/oa/oaflowtemp", Name="OaFlowTempManagement", Component="/system/oa/oaFlowTemp/index",  Icon="fa fa-pied-piper", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000130, Pid=1300000000129, Title="查询", Permission="oaFlowTemp:page", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000131, Pid=1300000000129, Title="编辑", Permission="oaFlowTemp:edit", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000132, Pid=1300000000129, Title="增加", Permission="oaFlowTemp:add", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000133, Pid=1300000000129, Title="删除", Permission="oaFlowTemp:delete", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000134, Pid=1300000000129, Title="详情", Permission="oaFlowTemp:detail", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },

            new SysMenu{ Id=1300000000135, Pid=1300000000122, Title="流程实例", Path="/oa/oaflowmain", Name="OaFlowMainManagement", Component="/system/oa/oaFlowMain/index",  Icon="fa fa-sign-language", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000136, Pid=1300000000135, Title="查询", Permission="oaFlowMain:page", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000137, Pid=1300000000135, Title="编辑", Permission="oaFlowMain:edit", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000138, Pid=1300000000135, Title="增加", Permission="oaFlowMain:add", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000139, Pid=1300000000135, Title="删除", Permission="oaFlowMain:delete", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000140, Pid=1300000000135, Title="详情", Permission="oaFlowMain:detail", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },

            new SysMenu{ Id=1300000000141, Pid=1300000000122, Title="流程待办", Path="/oa/systodomain", Name="SysTodoMainManagement", Component="/system/oa/sysTodoMain/index",  Icon="fa fa-linode", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000142, Pid=1300000000141, Title="查询", Permission="sysTodoMain:page", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000143, Pid=1300000000141, Title="编辑", Permission="sysTodoMain:edit", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000144, Pid=1300000000141, Title="增加", Permission="sysTodoMain:add", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000145, Pid=1300000000141, Title="删除", Permission="sysTodoMain:delete", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000146, Pid=1300000000141, Title="详情", Permission="sysTodoMain:detail", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },

            new SysMenu{ Id=1300000000147, Pid=0, Title="书海翱翔", Path="/book", Name="book", Component="Layout", Redirect="/book/poetry", Icon="fa fa-telegram", Type=MenuTypeEnum.Dir, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },

            new SysMenu{ Id=1300000000148, Pid=1300000000147, Title="诗香文地", Path="/book/poetry", Name="PoetryManagement", Component="/system/poetry/index",  Icon="fa fa-shower", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000149, Pid=1300000000148, Title="查询", Permission="poetry:page", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000150, Pid=1300000000148, Title="编辑", Permission="poetry:edit", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000151, Pid=1300000000148, Title="增加", Permission="poetry:add", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000152, Pid=1300000000148, Title="删除", Permission="poetry:delete", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000153, Pid=1300000000148, Title="详情", Permission="poetry:detail", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },

            new SysMenu{ Id=1300000000154, Pid=1300000000147, Title="通讯", Path="/book/contact", Name="ContactManagement", Component="/system/phoneContact/index",  Icon="ele-Mug", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000155, Pid=1300000000154, Title="查询", Permission="contact:page", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000156, Pid=1300000000154, Title="编辑", Permission="contact:edit", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000157, Pid=1300000000154, Title="增加", Permission="contact:add", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000158, Pid=1300000000154, Title="删除", Permission="contact:delete", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1300000000159, Pid=1300000000154, Title="详情", Permission="contact:detail", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
