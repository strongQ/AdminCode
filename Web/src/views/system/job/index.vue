	...
	<div class="sys-job-container">
		...
		<el-card shadow="hover" style="margin-top: 8px">
			<el-table :data="state.jobData" style="width: 100%" v-loading="state.loading" border>
				...
				<!-- <el-table-column prop="jobDetail.annotations" label="扫描特性触发器" align="center" show-overflow-tooltip>
					<template #default="scope">
						<el-tag v-if="scope.row.jobDetail.annotations == true"> 是 </el-tag>
...
const openAddJobDetail = () => {
	...
	editJobDetailRef.value?.openDialog({ concurrent: true, annotations: true, groupName: 'default', createFromScript: true });
};
